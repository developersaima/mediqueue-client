...
export default function MyBookingsPage() {
  ...
  const handleConfirmCancel = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${baseUrl}/api/bookings/${selectedBookingId}/cancel`,
        {
          method: "PATCH",
              ...
              <table className="table w-full text-sm">
                ...
                <tbody>
                  {bookings.map((booking) => (
                    <tr
                      key={booking._id}
                      className="hover:bg-base-200/20 border-b border-base-200 last:border-none transition-colors"
                    >
                      <td className="py-4 px-6 font-medium text-base-content">
                        {booking.studentName}
                      </td>
                      ...
                      <td className="py-4 px-6 font-semibold text-base-content">
                        {booking.tutorName}
                      </td>
